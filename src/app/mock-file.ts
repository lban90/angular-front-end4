...
export const APPOINTMSNTS: Appointment[] = [
  {appointment_id: 1, appointment_client_first_name: 'Ioan',
  ...
  {appointment_id: 7, appointment_client_first_name: 'Ioan',
